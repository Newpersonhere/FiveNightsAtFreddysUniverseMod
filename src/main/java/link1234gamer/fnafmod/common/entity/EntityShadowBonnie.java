...
public class EntityShadowBonnie extends EntityMob
{
    ...
    public EntityShadowBonnie(World world)
    {
        super(world);
    ...
    {
        return this.isScreaming() ? "fnafmod:mob.ffreddy.scream" : "fnafmod:mob.gfreddy.say";
    }
    ...
    {
        return "fnafmod:mob.animatronic.hurt";
    }
