...
public class EntityFreddyAIAttackOnCollide extends EntityAIBase
{
    World worldObj;
    EntityFreddy attacker;
    int attackTick;
    ...
    public EntityFreddyAIAttackOnCollide(EntityFreddy p_i1635_1_, Class p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_)
    {
        this(p_i1635_1_, p_i1635_3_, p_i1635_5_);
        this.classTarget = p_i1635_2_;
    }

    public EntityFreddyAIAttackOnCollide(EntityFreddy p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_)
    {
    ...
    {
        EntityLivingBase entitylivingbase = this.attacker.getAttackTarget();
        return entitylivingbase == null ? false : (!entitylivingbase.isEntityAlive() ? true : (!this.longMemory ? !this.attacker.getNavigator().noPath() : this.attacker.isWithinHomeDistance(MathHelper.floor_double(entitylivingbase.posX), MathHelper.floor_double(entitylivingbase.posY), MathHelper.floor_double(entitylivingbase.posZ))));
    }
