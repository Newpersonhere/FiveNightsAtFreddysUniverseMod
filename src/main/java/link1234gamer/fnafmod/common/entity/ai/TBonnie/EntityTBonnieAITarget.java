package link1234gamer.fnafmod.common.entity.ai.TBonnie;
...
public abstract class EntityTBonnieAITarget extends EntityAIBase
{
    protected EntityToyBonnie taskOwner;
    ...
    public EntityTBonnieAITarget(EntityToyBonnie p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntityTBonnieAITarget(EntityToyBonnie p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
