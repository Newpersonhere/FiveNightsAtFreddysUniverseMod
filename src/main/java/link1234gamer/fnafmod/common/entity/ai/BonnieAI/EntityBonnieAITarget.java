package link1234gamer.fnafmod.common.entity.ai.BonnieAI;
...
public abstract class EntityBonnieAITarget extends EntityAIBase
{
    protected EntityBonnie taskOwner;
    ...
    public EntityBonnieAITarget(EntityBonnie p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntityBonnieAITarget(EntityBonnie p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
