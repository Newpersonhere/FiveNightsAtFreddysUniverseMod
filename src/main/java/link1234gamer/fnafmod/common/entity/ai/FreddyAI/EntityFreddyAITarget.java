...
public abstract class EntityFreddyAITarget extends EntityAIBase
{
    protected EntityFreddy taskOwner;
    ...
    public EntityFreddyAITarget(EntityFreddy p_i1669_1_, boolean p_i1669_2_)
    {
        this(p_i1669_1_, p_i1669_2_, false);
    }

    public EntityFreddyAITarget(EntityFreddy p_i1670_1_, boolean p_i1670_2_, boolean p_i1670_3_)
    {
